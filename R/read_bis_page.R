read_bis_page<-function(x,countries_cb){
  page_summary<-tidyRSS::tidyfeed(paste0("https://www.bis.org/doclist/cbspeeches.rss?from=&till=&page=",x,
  ...
  tibble(title,speaker,cb,country,speaker_position,event,date,link,text)
}
